...
public class XmlUtils {
	public List<Student> dom2xml(InputStream is) throws Exception {
      ...
      DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();//获取 DocumentBuilderFactory 的新实例
       DocumentBuilder builder = factory.newDocumentBuilder();//使用当前配置的参数创建一个新的 DocumentBuilder 实例。
        //获得Document对象
        Document document = builder.parse(is);//将给定 URI 的内容解析为一个 XML 文档，并且返回一个新的 DOM Document 对象。(url是相对路径---项目)
        //获得student的List
